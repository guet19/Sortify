<script>
    ...
    // --- FILTER STATES (Aus deiner Web-App) ---
    let searchQuery = "";
    ...
    // 3. DYNAMISCHE SIDEBAR-FILTER (Kaskadierend + Einzel-Optionen ausblenden)
...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* WICHTIG: Das ist die Anpassung für den Titel (max. 2 Zeilen) */
    .card-content h3 { 
        margin: 0; 
        font-size: 1.15rem; /* Schriftgröße leicht verkleinert für besseren Flow */
        line-height: 1.4;   /* Angenehmer Zeilenabstand */
        display: -webkit-box;
        -webkit-line-clamp: 2; /* Erlaubt maximal 2 Zeilen, dann wird abgekürzt (...) */
        -webkit-box-orient: vertical;
        overflow: hidden;
        white-space: normal; /* Hebt das alte nowrap auf */
    }
